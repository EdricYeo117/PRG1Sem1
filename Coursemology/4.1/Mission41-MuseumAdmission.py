...
def calculate_cost(total_no_visitors, num_SC_PR):
    if num_SC_PR != 0 :        #Check number of other visitors
        ...
        total_cost = total_no_visitors * 15  #calculate total price of tickets
        print(total_cost) #Modify to display that Admission is free for all        
    return total_cost #Do not remove this line that returns the result
#Prompt and accept data from user.
#total_no_visitors = input("Enter the total number of visitors to the museum:")
#num_SC_PR = input("Enter the total number of Singaporeans and Permanent Residents")
