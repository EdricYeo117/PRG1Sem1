...
def calculate_average(mthly_cost):
    ...
    average = ((float(list1[0]) + float(list1[1]) + float(list1[2]))/3)
...
#electric_cost = input("Enter the electrical cost($) for 3 months seperated by semicolon: ")
#Do not edit/remove the next line that calls the function to get the average
#average = calculate_average(electric_cost)
